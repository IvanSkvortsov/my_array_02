...
{
	assert( this->_M_data == 0 );// should be zero when allocating pointer
	//assert( __size > sizeof(size_type) );
...
my_array::my_array(): _M_data(){__login__( std::clog, this, function_name() ); }
